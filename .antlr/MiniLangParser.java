...
public class MiniLangParser extends Parser {
	...
	public static final int
		...
		FIMENQUANTO=16, BREAK=17, CONTINUE=18, MAIS=19, MENOS=20, MULT=21, DIV=22, 
		ABRE_PAR=23, FECHA_PAR=24, OPERADOR_RELACIONAL=25, PV=26, DOIS_PONTOS=27, 
		VIRGULA=28, PONTO=29, ATRIB=30, NUMERO=31, ID=32, WS=33;
	public static final int
		...
		RULE_termo = 12, RULE_fator = 13, RULE_enquanto = 14;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"expressaoAritmetica", "termo", "fator", "enquanto"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"FACA", "FIMENQUANTO", "BREAK", "CONTINUE", "MAIS", "MENOS", "MULT", 
			"DIV", "ABRE_PAR", "FECHA_PAR", "OPERADOR_RELACIONAL", "PV", "DOIS_PONTOS", 
			"VIRGULA", "PONTO", "ATRIB", "NUMERO", "ID", "WS"
		};
	}
	...
	public final BlocoContext bloco() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4295378432L) != 0)) {
				{
				{
				setState(41);
				comando();
